  ...
  <Scroller layout="left">
    ...
    {#snippet scrolly()}
      <ObservedArticleText callback={removeDuckCallback} {options}>
        This example shows how to use an Intersection Observer callback along
        with a <a href="https://svelte.dev/docs/svelte/transition"
          >Svelte transition.</a
        >
        <br /><br />
        Svelte transitions are built-in, easy to use animations that elevate the
        user experience as elements change on the website. Try them out in the tutorial
        <a href="https://svelte.dev/tutorial/svelte/transition">here</a>
        (and the next few pages).
        <br /><br />
        You can also
        <a href="https://svelte.dev/tutorial/svelte/custom-css-transitions">
      ...
      <ObservedArticleText callback={showDuckCallback} {options}>
        ...
        <code>duckIsVisible==true</code>, Svelte automatically updates the page
        and adds the duck component.
        <br /><br />
      ...
      <ObservedArticleText callback={removeDuckCallback} {options}>
        ...
        <br /><br />
        Svelte then automatically updates the page (more precisely, the DOM) and
        removes the duck component.
        <br /><br />
        The Svelte transition
        <code>{"out:fade"}</code>
      ...
      <ObservedArticleText callback={simpleCallback} {options}>
        ...
        🤔
        <strong
          >How might you use a transition like this for emotional impact in your
          final project?</strong
        >
      </ObservedArticleText>
    {/snippet}
  </Scroller>
